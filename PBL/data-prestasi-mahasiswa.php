    ...
    <script>
        $(document).ready(function () {
            ...
            const table = $('#prestasiTable').DataTable({
                ajax: {
                    url: 'assets/php/get_prestasi.php',  // Path to the PHP file for fetching data
                    type: 'POST',
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.error) {
                ...
                `;
                $('#prestasiDetails').html(prestasiDetails); // Set the modal content
                ...
                // Check if a certificate URL exists in the response and clean the file path
                ...
                // Check if a poster URL exists in the response and clean the file path
                ...
                // Check if a sertifikat URL exists in the response and clean the file path
                ...
                // Check if a foto_kegiatan URL exists in the response and clean the file path
