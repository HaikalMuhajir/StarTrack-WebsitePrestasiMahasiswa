...
$_SESSION['jurusan'] = strtoupper($dataAdmin['jurusan']);
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-4 col-xl-12">
                                    <div class="card info-card revenue-card">
                                        <div class="card-body">
                                            <h5 class="card-title text-center">Mahasiswa Berprestasi</h5>
                                            <div class="d-flex justify-content-center align-items-center text-center">
                                                ...
                                                <div class="ps-3">
                                                    <h6><?php echo getMahasiswa($conn) ?></h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <script>
                                            document.addEventListener("DOMContentLoaded", () => {
                                                ...
                                                function filterDataByYear(year) {
                                                    if (Number.isInteger(Number(year))) {
                                                        $.ajax({
                                                            url: 'assets/php/queryAdminJurusan.php',
                                                            type: 'POST',
                                                            data: {
                                                                year: year
                                                            },
